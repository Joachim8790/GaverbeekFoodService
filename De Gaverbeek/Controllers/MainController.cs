        ...
        public ActionResult Index(ContactViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //{
                    ...
                    msg.Body = "<h2>Nieuw bericht van " + vm.Naam + "</h2><br/> <b>Emailadres correspondent:</b> " + vm.Emailadres + "<br/><b>  Onderwerp: </b>" + vm.Onderwerp + "<br/><b> Verstuurd bericht: </b></br>" + vm.Bericht;
                    msg.IsBodyHtml = true;
                    client.Send(msg);
                    ModelState.Clear();
